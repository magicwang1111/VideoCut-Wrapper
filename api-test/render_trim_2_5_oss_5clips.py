"""Render one 5-clip OSS folder with trim-2-5-concat.
...
OSS_TEST_URI = os.getenv(
    "OSS_TEST_URI",
    "oss://goumee-coze/GouMei-Video-Cut/test-input/20260605\u6df7\u526a\u7d20\u6750/",
)
...
def download_task(task_id: str) -> Path:
    ...
    target = DOWNLOAD_DIR / f"trim-2-5-concat-{task_id}.mp4"
